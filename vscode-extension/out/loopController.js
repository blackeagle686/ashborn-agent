...
class LoopController {
    ...
    async _askUserApproval(actions) {
        ...
        const choice = await vscode.window.showInformationMessage(`Ashborn is requesting approval for the following actions:\n\n${summary}`, { modal: true }, "Approve", "Modify Command", "Deny");
        if (choice === "Approve") {
